 ...
 * 上传文件类
 */
package cn.libra.server.util.helper;
...
import cn.libra.server.util.StringUtil;
import cn.libra.server.util.ThumbnailGenerator;
...
public class UploadHelper {
	...
	public final static String BASE_PATH = System.getProperties().getProperty("user.home")+ "\\Libra" + "\\File";
